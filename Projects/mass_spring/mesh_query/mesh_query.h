...
MeshObject* construct_mesh_object(int num_vertices,
                      const double *positions,
                      int num_triangles,
                      const int *triangles);

// Cleans up a previously allocated mesh object.
void destroy_mesh_object(MeshObject *mesh);
...
bool point_inside_mesh(const double point[3],
...
// intersections.
bool segment_intersects_mesh(const double point0[3],
